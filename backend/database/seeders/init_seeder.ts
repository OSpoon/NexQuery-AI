  ...
  async run() {
    ...
    const mainMenus = [
      {
        ...
        component: '@/pages/dashboard/home.vue',
        sortOrder: 10,
        parentId: null,
      },
      {
      ...
      },
      {
        ...
        component: '@/pages/knowledge-base/index.vue',
        sortOrder: 50,
        parentId: null,
      },
      {
        ...
        component: '@/pages/feedback/index.vue',
        sortOrder: 60,
        parentId: null,
      },
    ]
    ...
    const defaultSettings = [
      ...
      { key: 'ai_chat_model', value: 'glm-4.5-flash', type: 'string', group: 'ai' },
      {
        ...
        description: 'Model for text embeddings (e.g., embedding-3).',
      },
      {
        key: 'ai_timeout_sec',
        value: '600',
        ...
        description: 'Maximum duration in seconds for AI models to respond.',
      },
      {
        ...
        type: 'string',
        group: 'ai',
        label: 'AI Transcription Base URL',
        description:
          'Independent Base URL for STT (Whisper). Leave empty to use global AI Base URL.',
      },
      {
        ...
        type: 'string',
        group: 'ai',
        label: 'AI Transcription API Key',
        description: 'Independent API Key for STT (Whisper). Leave empty to use global AI API Key.',
      },
      {
