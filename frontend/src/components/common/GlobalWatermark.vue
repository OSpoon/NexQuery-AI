...
const initTamperProof = () => {
    ...
    tamperObserver = new MutationObserver((mutations) => {
        ...
        for (const mutation of mutations) {
            ...
            if (mutation.type === 'attributes' && mutation.target instanceof HTMLElement && mutation.target.id === 'global-watermark-overlay') {
...
<template>
    <div v-if="watermarkUrl" id="global-watermark-overlay" class="fixed inset-0 z-[9999] pointer-events-none"
